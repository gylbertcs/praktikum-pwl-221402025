...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tema -->
            <li class="nav-item {{ request()->is('admin/tema') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/tema">
                    <i class="fa fa-file" aria-hidden="true"></i>
                    <span>Tema Berita</span></a>
            </li>

            <!-- Nav Item - Rincian -->
            <li class="nav-item {{ request()->is('admin/rincian') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/rincian">
